...
#ifndef __CPLEX_MVC_H__
#define __CPLEX_MVC_H__
...
class CplexMVC : public Measure{
    unsigned int support();
public:
    CplexMVC(vector<Occurance> OccuranceList,vector<EdgeNEWFw> DFSList): Measure(OccuranceList,DFSList){
        double tstart, tstop;
        tstart = dtime();
